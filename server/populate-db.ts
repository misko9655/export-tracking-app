// import {ITEMS} from '../server/src/model/db-data';
...
// const MONGODB_CONNECTION_URL = 'mongodb+srv://milosmilutinovic_db_user:KF57Vput9ig6qta4@cluster0.i2owkmc.mongodb.net/';

// // Database Name
// const dbName = 'export-tracking-app-db';
